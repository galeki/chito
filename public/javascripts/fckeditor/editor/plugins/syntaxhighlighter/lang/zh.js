...
FCKLang.SyntaxHighlighterLine	= '起始行号: ';
FCKLang.SyntaxHighlighterCodeTitle	= '代码标题: ';
FCKLang.SyntaxHighlighterCollapse	= '折叠代码';
FCKLang.SyntaxHighlighterTip1	= '不要忘记在 Chito 的插件设置中激活 Syntax Highlighter。';
FCKLang.SyntaxHighlighterTip2	= '高亮的效果不会显示在编辑器中，但是会自动显示在文章浏览界面。';
