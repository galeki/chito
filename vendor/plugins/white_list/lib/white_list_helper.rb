...
WhiteListHelper.tags       = %w(h1 h2 h3 h4 h5 h6 hr u strong em b i p code pre sub sup cite small address br div span ul ol li dt dd abbr acronym a img blockquote )
WhiteListHelper.attributes = %w( href src alt cite title class style id )
