        ...
        def get_relative_posts_before_post_show
            if @post && @user.show_postbars
                ...
                if tag_list.blank?
                    ...
                    if @user.show_relative_posts && !postbar_cache_enable(:relative_posts, :in => 20.hours, :post => @post.id)
                    ...
                    if @user.show_global_relative_posts && !postbar_cache_enable(:global_relative_posts, :in => 20.hours, :post => @post.id)
